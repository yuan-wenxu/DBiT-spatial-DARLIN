...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--length_spot', type=int, default=20, help='Length of each spot in μm')
    parser.add_argument('-i', '--interval', type=int, default=20, help='Interval between two adjacent spots in μm')
